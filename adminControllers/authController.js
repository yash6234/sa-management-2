...
const VerifyOTP = async (req, res) => {
    try {
        ...
        //      data: encryptData({ user: encdata, expiryStatus: encryptData(expiryStatus) }),
        //          message: encryptData({ msg1: encryptData("OTP_Verified_Successfully_And_Response_Token_Sent"),
        //              daysLeft: encryptData(daysLeft >= 0 ? daysLeft : 0), 
        //              msg2: encryptData(expiryStatus) })  });
